...
def show_interactive_menu():
    ...
    while True:
        ...
        choice = prompt("請輸入選項 [1-4] (4): ", default="4")
        ...
        if choice == "1":
            ...
            try:
                ...
                start_date = prompt("請輸入開始日期 (YYYY-MM-DD) [可選]: ", default="")
                end_date = prompt("請輸入結束日期 (YYYY-MM-DD) [可選]: ", default="")
                skip_dates = prompt("請輸入要跳過的日期 (YYYY-MM-DD,...) [可選]: ", default="")
